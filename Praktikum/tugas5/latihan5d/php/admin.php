...
<body>
  ...
  <div class="add">
    <a href="tambah.php">
      <button type="button" class="btn btn-outline-secondary" style="margin:20px 119px;">Tambah Data</button>
  ...
  <div class="container">
    ...
    <table class="table table-striped table-dark">
      ...
      <?php foreach ($makanan as $item) : ?>
        ...
        <table>
          <div class="sumber"><a href="https://www.hollandbakery.co.id/" target="_blank">https://www.hollandbakery.co.id/</a></div>
        </table>
